...
public class RandomAnnotationProcessor {
    ...
    public static <T> void processAnnotation(T obj) {
        // найти все поля класса, над которыми стоит аннотация @Random или @RandomDate
        // вставить туда рандомное число в зависимости от типа данных поля
